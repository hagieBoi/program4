...
public void circleTest(){
	...
	Assert.assertEquals("Radius equals 10",(int)test0.radius, 10);
}

//Testing whether or not negative numbers work, with a proven case.
@Test
public void intersectsCircle(){
	Circle1 test1 = new Circle1(1,2,3);	
	Circle1 test2 = new Circle1(-1,-2,3);
...
public void scaleCircle(){
	Circle test3 = new Circle1(2,2,10);
...
public void moveByTest(){
	Circle test4 = new Circle1(2,2,2);	
